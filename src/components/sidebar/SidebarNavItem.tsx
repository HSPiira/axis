...
const SidebarNavItem: React.FC<SidebarNavItemProps> = ({ icon, label, to, active }) => {
    ...
    const baseClasses = "group flex items-center md:items-center md:justify-center lg:justify-start lg:gap-2 lg:w-full lg:flex lg:flex-row lg:items-center rounded-md px-1.5 py-1.5 text-xs text-gray-700 dark:text-gray-300 hover:bg-white dark:hover:bg-gray-800 hover:text-black dark:hover:text-white transition-colors";
    const activeClasses = "bg-white dark:bg-gray-800 text-black dark:text-white font-semibold";
