        ...
        >
            ...
            <motion.div variants={item} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Import Clients</h1>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Import your client data from a CSV or Excel file
                        </p>
                    </div>
                </div>

                {/* Import form will go here */}
            </motion.div>
        </motion.div>
    );
} 