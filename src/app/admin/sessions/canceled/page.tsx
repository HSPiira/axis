...
export default function CanceledSessionsPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[300px] border border-dashed border-gray-200 rounded-2xl py-16">
            ...
            <h2 className="text-xl font-bold mb-2 text-center">No canceled bookings</h2>
            <p className="text-gray-600 text-center max-w-md">
                You have no canceled bookings. Your canceled bookings will show up here.
            </p>
        </div>
    );
} 